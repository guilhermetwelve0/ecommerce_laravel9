                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{url('admin/update-admin-details') }}" method="post" enctype="multipart/form-data">@csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="admin_mobile" placeholder="Enter 11 Digit Mobile Number" name="admin_mobile" value="{{Auth::guard('admin')->user()->mobile}}" required="" maxlength="15" minlength="10">
                            </div>
                            <div class="form-group">
...
@endsection
 ...
 <!-- o que esta de errado nesse codigo @if(!empty(Auth::guard('admin')->user()->image))
<a target="_blank" href="{{ url('admin/images/photos/
                                    '.Auth::guard('admin')->user()->image) }}">View Image</a>
@endif -->
